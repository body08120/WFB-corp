  ...
  <footer class="footerprim ml-4 mr-4 md:ml-0 md:mr-0">
    <div class="mx-auto w-full lg:py-8 xl:px-52">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-blanc sm:text-center ">© 2023
          <a href="https://flowbite.com/" class="hover:underline hover:text-blanc">WFB Corporation™</a>. Tous droits réservés.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="#" class="text-grenat hover:text-blanc">
