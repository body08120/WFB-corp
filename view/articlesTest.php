    ...
    <main class="h-full overflow-hidden flex items-center justify-center" style="background: #141414;">
        <div class="space-y-5 w-9/12">
            ...
            <div class="overflow-hidden rounded-xl border border-[#171717] bg-[#141414]-50 p-1 mt-6">
                ...
                <?php
// Supposons que vous avez récupéré les données de la base de données dans un tableau appelé $articles
// Chaque élément du tableau $articles représente une carte avec les informations nécessaires

$maxCards = 6; // Nombre maximum de cartes à afficher
...
<div id="all-section" class="mt-4">
    <div id="cards" style="margin: auto;">
        ...
        for ($i = 0; $i < min($maxCards, count($articles)); $i++) {
            $article = $articles[$i]; // Récupérer les données de l'article actuel
        ?>
            <div class="card">
                <div class="card-content">
                    <div class="card-image">
                        <img src="<?php echo $article['image']; ?>" alt="<?php echo $article['alt']; ?>" width="250px">
                    </div>
                    <div class="card-info-wrapper">
                        <div class="card-info">
                            <div class="card-info-title">
                                <h3 class="category_articles"><?php echo $article['category']; ?></h3>
        ...
        <?php if (count($articles) > $maxCards) {
            $lastArticle = $articles[count($articles) - 1];
        ?>
            <div class="card">
                <div class="card-content">
                    <div class="card-image">
                        <img src="<?php echo $lastArticle['image']; ?>" alt="<?php echo $lastArticle['alt']; ?>" width="250px">
                    </div>
                    <div class="card-info-wrapper">
                        <div class="card-info">
                            <div class="card-info-title">
                                <h3 class="category_articles"><?php echo $lastArticle['category']; ?></h3>
                                <h4><?php echo $lastArticle['title']; ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
