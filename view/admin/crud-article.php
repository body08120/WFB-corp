...
<div class="w-full relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="pb-4 bg-primary dark:bg-gray-900">
        ...
        <div class="relative p-4">
            ...
            <input type="text" id="table-search" class="block p-2 pl-10 text-sm text-third rounded-lg w-80 bg-secondary focus:ring-grenat focus:border-grenat" placeholder="Search for items">
        </div>
    </div>
